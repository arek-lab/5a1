...
export function ThemeToggle() {
  const t = useTranslations('guest.theme');
  ...
  return (
    <button
      ...
      className="flex h-11 w-11 items-center justify-center rounded-full text-guest-ink-muted hover:bg-guest-stone hover:text-guest-ink"
    >
